@extends('dashboard.layouts.master', ['title' => 'لیست برند ها'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">لیست برند ها</span>
            </div>
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <button data-toggle="modal" data-target="#AddBrandModal" style="margin-right: 20px;" type="button" class="btn btn-sm btn-outline-success">افزودن برند جدید</button>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #2" data-field="2">آیکون</th>
                                <th title="Field #5" data-field="5">برند</th>
                            ...
                            @foreach($brands as $brand)
                                <tr role="row" class="odd icon-hover hover-color">
                                    ...
                                    <td>
                                        @if($brand->icon == null)
                                            <img src="{{ asset('/dashboard/assets/images/img-na.png') }}" class="rounded w-27" alt="">
                                        @endif
                                            <img src="{{ $brand->icon['250,250'] }}" class="rounded" alt="">
                                    </td>
                                    <td>{{ $brand->name }}</td>
                                    <td>
                                        <a target="_blank" href="{{ route('shop.brand', $brand->id ) }}" title="مشاهده محصولات برند"><i class="fa fa-eye text-success mr-1 button font-18"></i></a>
                                        <a href="{{ route('brands.edit', $brand->id) }}" ><i class="far fa-edit text-info mr-1 button font-15"></i></a>
                                        ...
                                        @else
                                            <a href="" id="remove" title="حذف" data-name="{{ $brand->name }}" data-id="{{ $brand->id }}"><i class="far fa-trash-alt text-danger font-15"></i></a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
        ...
        $(document).on('click', '#remove', function (e) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        type: "POST",
                        url: "{{url('/dashboard/brands/delete')}}",
                        data: {id: id},
                        success: function (data) {
                            var url = document.location.origin + "/dashboard/brands";
                            location.href = url;
                        }
                    });
                });
