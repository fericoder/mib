@extends('dashboard.layouts.master', ['title' => 'ویرایش بنر'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">ویرایش بنر</span>
            </div>
            ...
            <div class="col-xl-12">
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        <!--begin: Datatable -->
                        <form action="{{ route('banner.update', $banner->id) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <input type="text" class="form-control inputfield" value="{{ old('title', $banner->title ) }}" name="title" >
                                </div>
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <input type="text" class="form-control inputfield" value="{{ old('url', $banner->url ) }}" name="url" >
                                </div>
