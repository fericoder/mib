            ...
            <div class="col-xl-12">
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        <!--begin: Datatable -->
                        <form action="{{ route('faqs.update', ['faq' => $faq, 'id' => $faq->id]) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-group mb-0">
                                <div class="input-group mt-3">
                                    ...
                                    <input type="text" class="form-control inputfield" name="title" value="{{ old('title', $faq->title) }}">
                                </div>
                                <div class="input-group mt-3">
                                    <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"><i
                                                    class="fas fa-star required-star mr-1"></i> سوال:</span></div>
                                    <input type="text" class="form-control inputfield" name="question" value="{{ old('question', $faq->question) }}">
                                </div>
                                <div class="input-group mt-3">
                                    <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"><i
                                                    class="fas fa-star required-star mr-1"></i>پاسخ :</span></div>
                                    <input type="text" class="form-control inputfield" name="answer" value="{{ old('answer', $faq->answer) }}">
                                </div>
                            </div>
                            <!--end form-group-->
                    </div>
