@extends('dashboard.layouts.master', ['title' => 'لیست سفارشات مشتری'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">لیست سفارشات مشتری</span>
            </div>
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                <th title="Field #1" data-field="1">شناسه سفارش</th>
                                <th title="Field #1" data-field="1">تاریخ ثبت</th>
                                <th title="Field #1" data-field="1">مجموع قیمت</th>
                                <th title="Field #2" data-field="2">آدرس</th>
                                <th title="Field #5" data-field="5">روش پرداخت</th>
                                <th title="Field #5" data-field="5">وضعیت</th>
                                <th title="Field #6" data-field="6">لیست کالاها</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach ($purchases as $purchase)
                                <tr>
                                    ...
                                    <td style="font-family: BYekan!important; direction: ltr" >{{ jdate($purchase->created_at) }}</td>
                                    <td style="font-family: BYekan" >{{ number_format($purchase->total_price) }}</td>
                                    ...
                                    <td style="font-family: BYekan" >{{ $purchase->payment_method }}</td>
                                    <td style="font-family: BYekan" >{{ $purchase->status }}</td>
                                    <td>
