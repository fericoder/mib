@extends('dashboard.layouts.master', ['title' => 'لیست محصولات سفارش'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">لیست محصولات سفارش</span>
            </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #1" data-field="1">قیمت</th>
                                <th title="Field #2" data-field="2">تعداد</th>
                                <th title="Field #5" data-field="5">کد CRM محصول</th>
                            </tr>
                            </thead>
                            <tbody>
                            ...
                            @foreach ($purchase->cart()->withTrashed()->where('status' , 1)->get()->first()->cartProduct as $product)
                                <tr>
                                    <td style="font-family: BYekan" ><a target="_blank" href="{{ route('shop.product',$product->product->id ) }}">{{ $product->product->id }}</a></td>
                                    <td style="font-family: BYekan" >{{ $product->product->title }}</td>
                                    <td style="font-family: BYekan" >{{ number_format($product->total_price) }}</td>
                                    <td style="font-family: BYekan" >{{ $product->quantity }}</td>
