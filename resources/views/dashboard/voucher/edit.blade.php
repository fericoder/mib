@extends('dashboard.layouts.master', ['title' => 'ویرایش برند'])
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">ویرایش سوال</span>
            </div>
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            {{--  <button data-toggle="modal" data-target="#AddProductModal" style="margin-right: 20px;" type="button" class="btn btn-sm btn-outline-success">افزودن برند جدید</button>  --}}
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        <!--begin: Datatable -->
                        <form action="{{ route('vouchers.update', ['voucher' => $voucher, 'id' => $voucher->id]) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            {{ method_field('PATCH') }}
                            <div class="form-group mb-0">
                                <div class="input-group mt-3">
                                    <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"><i
                                                    class="fas fa-star required-star mr-1"></i>نام کد تخفیف:</span></div>
                                    <input type="text" class="form-control inputfield" name="name" value="{{ old('name', $voucher->name) }}">
                                </div>
                                <div class="input-group mt-3">
                                    <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"><i
                                                    class="fas fa-star required-star mr-1"></i>میزان تخفیف :</span></div>
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <label style="margin: 10px;" class="kt-checkbox"><input {{ $voucher->type == 'number' ? 'checked' : '' }} id="togBtn" name="type" type="checkbox"> <span></span></label>
                                </div>
                            </div>
                            <!--end form-group-->
                    </div>
