@extends('dashboard.layouts.master', ['title' => 'لیست آیتم خصوصیت ها'])
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">افزودن آیتم خصوصیت جدید </h5>
                    ...
                    <form action="{{ route('specification-item.store', ['continue' => 1, 'shop' => $shop->english_name , 'specification_id' => $specification->id]) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-0">
                            <div class="input-group mt-3">
                                ...
                                <input type="text" class="form-control inputfield" value="{{ old('name') }}" name="name" placeholder="مثال: ۲ سانت">
                            </div>
                            <div class="input-group mt-3">
                                <div class="input-group-prepend min-width-180"><span class="input-group-text bg-light min-width-140" id="basic-addon7"><i
                                                class="fas fa-star required-star mr-1"></i>قیمت (ریال) :</span></div>
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container ">
            <div class="kt-subheader__main">
                ...
                <span class="kt-subheader__desc iranyekan">لیست آیتم خصوصیت ها</span>
            </div>
                ...
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            ...
                            <button data-toggle="modal" data-target="#AddBrandModal" style="margin-right: 20px;" type="button" class="btn btn-sm btn-outline-success">افزودن آیتم خصوصیت جدید</button>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <table style="font-family: iranyekan; width: 100%" class="table table-striped table-bordered table-hover table-checkable display nowrap" id="m_table_2">
                            ...
                            <tr>
                                ...
                                <th title="Field #2" data-field="2">قیمت (ریال)</th>
...
@section('footerScripts')
        ...
        $(document).on('click', '#remove', function (e) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        type: "POST",
                        url: "{{url('/dashboard/SpecificationItems/delete')}}",
                        data: {id: id},
    ...
    <script>
        ...
        $(document).on('click', '#restoreBrand', function(e) {
            ...
            var id = $(this).data('id');
            var name = $(this).data('name');
            swal(` ${'بازگردانی آیتم خصوصیت:'} ${name} | ${'آیا اطمینان دارید؟'}`, {
                dangerMode: true,
                icon: "warning",
                buttons: ["انصراف", "حذف"],
            })
        ...
        $(document).on('click', '#icon-delete', function(e) {
            ...
            var id = $(this).data('id');
            var name = $(this).data('name');
            swal(` ${'حذف عکس  آیتم خصوصیت:'} ${name} | ${'آیا اطمینان دارید؟'}`, {
                dangerMode: true,
                icon: "warning",
                buttons: ["انصراف", "حذف"],
            })
